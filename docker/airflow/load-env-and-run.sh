...
: "${AIRFLOW__API__SECRET_KEY:=local_dev_only_secret_key}"
...
export AIRFLOW_POSTGRES_HOST AIRFLOW_POSTGRES_PORT AIRFLOW_POSTGRES_DB
export AIRFLOW_POSTGRES_USER AIRFLOW_POSTGRES_PASSWORD
