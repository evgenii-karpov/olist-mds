...
(
    ...
    last_source_binlog_file_index Nullable(Int64),
    last_source_binlog_pos Nullable(Int64),
    last_source_row Nullable(Int32),
    last_transaction_total_order Nullable(UInt64),
    last_transaction_data_collection_order Nullable(UInt64),
