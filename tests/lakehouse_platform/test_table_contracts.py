...
EXPECTED_BUSINESS_COLUMNS = {
    ...
    "orders": (
        ...
        ("order_purchase_timestamp", "TIMESTAMP_NTZ", True),
        ("order_approved_at", "TIMESTAMP_NTZ", False),
        ("order_delivered_carrier_date", "TIMESTAMP_NTZ", False),
        ("order_delivered_customer_date", "TIMESTAMP_NTZ", False),
        ("order_estimated_delivery_date", "TIMESTAMP_NTZ", True),
    ),
    "order_items": (
        ("order_id", "STRING", True),
        ...
        ("shipping_limit_date", "TIMESTAMP_NTZ", True),
    ...
    "order_reviews": (
        ...
        ("review_creation_date", "TIMESTAMP_NTZ", True),
        ("review_answer_timestamp", "TIMESTAMP_NTZ", True),
    ),
    "products": (
        ("product_id", "STRING", True),
